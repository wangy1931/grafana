  ...
  constructor(
    ...
    this.kpiPanel = {
      ...
      rightItemTypes: {
        ...
        HostCpu: { id: 'HostCpu', name: 'page_topn_cpu_usr', data: '...', status: 'green', metrics: {} },
        HostMem: { id: 'HostMem', name: 'page_topn_mem_usage', data: '...', status: 'green', metrics: {} },
        HostIO: { id: 'HostIO', name: 'page_topn_disk_usage', data: '...', status: 'green', metrics: {} },
      },
      rightMetrics: [],
      leftSelected: '',
      rightSelected: '',
