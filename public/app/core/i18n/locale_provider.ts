 ...
 */
angular.module('cloudwiz.translate').provider('$translate', function ($STORAGE_KEY, $windowProvider) {
 ...
 */
angular.module('cloudwiz.translate').factory('$translateStaticFilesLoader', function ($q, $http) {
  return (options) => {
...
angular.module('cloudwiz.translate').factory('$translateDefaultInterpolation', function ($interpolate) {
...
angular.module('cloudwiz.translate').factory('$translateLocalStorage', function ($window) {
