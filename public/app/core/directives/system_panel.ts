  ...
  return {
    ...
    link: function(scope, elem, attr) {
      ...
      var getHealth = healthSrv.load().then(function(data) {
        ...
        var annomalyPieData = [{ label: '', data: scope.numMetrics }, { label: '', data: scope.numAnomalyMetrics }];
      ...
      var getHostStatus = backendSrv.getHosts(query).then(
        function(response) {
      ...
      $q.all([getHostStatus, getAlertNum, getAlertStatus]).then(
        function(result) {
