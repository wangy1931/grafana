...
var DayTableMixin = FC.DayTableMixin = {
	...
	sliceRangeByRow: function(range) {
		...
		var offsetEnd = 1;
		if(moment(normalRange.end._i).hour() > 8) {
			offsetEnd = 2;
		}
		var rangeLast = this.getDateDayIndex(normalRange.end.clone().subtract(offsetEnd, 'days')); // inclusive last index
		var segs = [];
		var row;
...
TimeGrid.mixin({
	...
	generateFgSegHorizontalCss: function(seg) {
		...
		props.marginRight = (right + left) * 100 / 24  + '%';

		console.log("top:" + props.top, 'props:'+props);
